...
- [📖 Math magicians](#-capstone-rick-and-morty)
...
> You can see the live demo of this project [here](https://mrcbq.github.io/math-magicians/)
...
```sh
  git clone https://github.com/mrcbq/math-magicians.git
```
